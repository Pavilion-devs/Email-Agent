"""Test script with simplified agents."""

import os
from dotenv import load_dotenv
from email_assistant.simple_agents import EmailCategorizerAgent, EmailResponderAgent, MeetingSchedulerAgent
...
def run_all_tests():
    """Run all tests."""
    print("🚀 Starting Smart Email Assistant Tests (Simplified)")
    print("=" * 50)
